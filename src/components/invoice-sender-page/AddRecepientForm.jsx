...
const AddRecepientForm = ({ partner, onOpenChange }) => {
    ...
    async function fetchEmails() {
        ...
        const emails = await getAvailabRecipients(partner.id, "to");
            ...
            <div className='space-y-4'>
                ...
                >
                    <SelectTrigger className="w-[280px]">
                        <SelectValue placeholder="Válassz címzettet..." />
                    </SelectTrigger>
                    <SelectContent>
...
export default AddRecepientForm